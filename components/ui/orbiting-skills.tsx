...
const OrbitingSkill = memo(({ config, angle }: OrbitingSkillProps) => {
  ...
  return (
    ...
    >
      <div
        className={`relative w-full h-full p-2 bg-gray-800/90 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer ${
